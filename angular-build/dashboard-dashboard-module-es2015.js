...
let AccountsummaryComponent = class AccountsummaryComponent {
    ...
    openModal(template, title, description) {
...
/* harmony import */ var _updatepassword_updatepassword_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./updatepassword/updatepassword.component */ "./src/app/dashboard/updatepassword/updatepassword.component.ts");
...
const routes = [{
        path: '', component: _dashboard_component__WEBPACK_IMPORTED_MODULE_3__["DashboardComponent"], children: [
            {
                path: '', component: _dashboardhome_dashboardhome_component__WEBPACK_IMPORTED_MODULE_4__["DashboardhomeComponent"]
            },
            {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('childModal', { static: true })
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _core_model_transaction_status__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../core/model/transaction.status */ "./src/app/core/model/transaction.status.ts");
/* harmony import */ var src_app_core_account_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/account.service */ "./src/app/core/account.service.ts");
...
let MinistatementComponent = class MinistatementComponent {
    constructor(accountService, authService, router) {
        this.accountService = accountService;
        this.authService = authService;
        this.router = router;
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_core_authentication_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/authentication.service */ "./src/app/core/authentication.service.ts");
/* harmony import */ var _core_model_transaction_status__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../core/model/transaction.status */ "./src/app/core/model/transaction.status.ts");
...
let TransactionhistoryComponent = class TransactionhistoryComponent {
    constructor(accountService, router, authService, modalService) {
        this.accountService = accountService;
        this.router = router;
        this.authService = authService;
        this.modalService = modalService;
    ...
    onDateChange(dateRange, dateType) {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('invalidDateTemplate', { static: true })
