...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSharedForgotpasswordForgotpasswordComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSharedRegisterRegisterComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_forgotpassword_forgotpassword_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./shared/forgotpassword/forgotpassword.component */
    "./src/app/shared/forgotpassword/forgotpassword.component.ts");
    /* harmony import */


    var _shared_register_register_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./shared/register/register.component */
    ...
    var routes = [{
      ...
      path: 'register',
      component: _shared_register_register_component__WEBPACK_IMPORTED_MODULE_6__["RegisterComponent"]
    }, {
      path: 'createpassword',
      component: _shared_createpassword_createpassword_component__WEBPACK_IMPORTED_MODULE_4__["CreatepasswordComponent"]
    }, {
      path: 'forgotpassword',
      component: _shared_forgotpassword_forgotpassword_component__WEBPACK_IMPORTED_MODULE_5__["ForgotpasswordComponent"]
    }, {
      path: 'dashboard',
  ...
  function srcAppCoreAccountServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_core_model_mock_transaction_history_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/core/model/mock-transaction-history.json */
    "./src/app/core/model/mock-transaction-history.json");

    var src_app_core_model_mock_transaction_history_json__WEBPACK_IMPORTED_MODULE_2___namespace =
    /*#__PURE__*/
    __webpack_require__.t(
    /*! src/app/core/model/mock-transaction-history.json */
    "./src/app/core/model/mock-transaction-history.json", 1);
    /* harmony import */


    var src_app_core_model_mock_account_summary_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/core/model/mock-account-summary.json */
    "./src/app/core/model/mock-account-summary.json");

    var src_app_core_model_mock_account_summary_json__WEBPACK_IMPORTED_MODULE_3___namespace =
    /*#__PURE__*/
    __webpack_require__.t(
    /*! src/app/core/model/mock-account-summary.json */
    "./src/app/core/model/mock-account-summary.json", 1);
    /* harmony import */
    ...
    function () {
      ...
      _createClass(AuthenticationService, [{
        ...
        value: function registerUser(user) {
          ...
          this.http.post(this.userUrl, user).subscribe(function (res) {
        ...
        key: "appLogin",
        value: function appLogin(loginForm) {
        ...
        key: "updatePwd",
        value: function updatePwd(cred) {
          return this.http.post(this.updatePwdUrl, cred);
        }
      }, {
        key: "setPwd",
        value: function setPwd(pwd) {
          return this.http.post(this.updatePwdUrl, pwd);
        }
      }, {
        key: "forgotPwd",
        value: function forgotPwd(pwd) {
          var headers = {
            'appName': 'REV_CARD'
          };
          return this.http.post(this.forgotPwdUrl, pwd, {
            headers: headers
          });
        }
      }]);
  ...
  /***/
  function srcAppCoreModelMockAccountSummaryJson(module) {
  ...
  /***/
  function srcAppCoreModelMockTransactionHistoryJson(module) {
  ...
  function srcAppSharedCreatepasswordCreatepasswordComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_core_authentication_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function CreatepasswordComponent(authService, router, activatedRouter, fb) {
      ...
      _createClass(CreatepasswordComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.activatedRouter.queryParams.subscribe(function (_ref) {
            ...
            _this2.email = email;
            _this2.passwordToken = passwordToken;
          });
        }
      }, {
        key: "setPassword",
        value: function setPassword() {
          ...
          this.authService.setPwd(this.createPasswordForm.value).subscribe(function () {
            _this3.router.navigate(["".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl, "login")]);
          });
        }
      }]);
  ...
  /***/
  function srcAppSharedForgotpasswordForgotpasswordComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSharedForgotpasswordForgotpasswordComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function ForgotpasswordComponent(authService, router, fb, http) {
      ...
      _createClass(ForgotpasswordComponent, [{
        ...
        key: "forgotPwdOnFocus",
        value: function forgotPwdOnFocus() {
          this.isFieldFocussed = true;
        }
      }, {
        key: "forgotPwdOnFocusOut",
        value: function forgotPwdOnFocusOut() {
          this.isFieldFocussed = false;
        }
      }, {
        key: "forgotPassword",
        value: function forgotPassword() {
          ...
          if (this.forgotPasswordForm.valid) {
            this.authService.forgotPwd(this.forgotPasswordForm.value).subscribe(function () {
              _this4.router.navigate(["".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].baseUrl, "login")]);
            }, function () {
    ...
    ForgotpasswordComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/forgotpassword/forgotpassword.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./forgotpassword.component.css */
      "./src/app/shared/forgotpassword/forgotpassword.component.css")).default]
      ...
      _createClass(HeaderComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.accountService.getTransactionHistory().subscribe(function (res) {
            //res = JSON.parse(res);
            _this5.legalName = res['Result'].array.RevTrxn[0].trxn.legalName;
          });
        }
      }, {
        key: "signout",
  ...
  function srcAppSharedLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(LoginComponent, [{
        ...
        key: "emailOnFocus",
        value: function emailOnFocus() {
          this.isEmailFocussed = true;
        }
      }, {
        key: "emailOnFocusOut",
        value: function emailOnFocusOut() {
          this.isEmailFocussed = false;
        }
      }, {
        key: "pwdOnFocus",
        value: function pwdOnFocus() {
          this.isPwdFocussed = true;
        }
      }, {
        key: "pwdOnFocusOut",
        value: function pwdOnFocusOut() {
          this.isPwdFocussed = false;
        }
      }, {
        key: "login",
  ...
  /***/
  function srcAppSharedRegisterRegisterComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSharedRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(RegisterComponent, [{
        ...
        key: "unameOnFocus",
        value: function unameOnFocus() {
          this.isUnameFocussed = true;
        }
      }, {
        key: "unameOnFocusOut",
        value: function unameOnFocusOut() {
          this.isUnameFocussed = false;
        }
      }, {
        key: "emailOnFocus",
  ...
  function srcAppSharedSharedModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _forgotpassword_forgotpassword_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
  ...
  function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var environment = {
      ...
      soapUrl: 'https://praveeng-1002.herokuapp.com/' //soapUrl:'http://localhost:8080/'
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\projects\reform\myrcard\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
